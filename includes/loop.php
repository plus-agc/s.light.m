...
function anima_posted_author() {
	...
	if ( $anima_meta_author ) {
		echo sprintf(
			...
			sprintf( esc_attr__( 'View all posts by %s', 'anima' ), esc_attr( get_the_author() ) ),
...
function anima_posted_author_single() {
	...
	if ( $anima_meta_author ) {
		echo sprintf(
			...
			sprintf( esc_attr__( 'View all posts by %s', 'anima' ), esc_attr( get_the_author_meta( 'display_name', $author_id) ) ),
